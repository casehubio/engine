...
class BindingDeserializerTest {
  ...
  void humanTaskBinding_deserializes() throws Exception {
    ...
    JudgmentTarget ht = (JudgmentTarget) result.target();
    assertNotNull(ht.routingConfig());
    assertInstanceOf(io.casehub.api.model.HumanRoutingConfig.class, ht.routingConfig());
  }
