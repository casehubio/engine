 ...
 *
 * <ul>
 *   <li>{@link PlanItemRef} — {@code "case:{caseId}/pi:{planItemId}"} — standard WorkItem created
 *       from a humanTask YAML binding. Routes back to a blackboard PlanItem.
 *   <li>{@link GateRef} — {@code "case:{caseId}/gate:{gateId}"} — WorkItem created for an action
 *       gate. Routes to {@code ActionGateCompletionApplier}; bypasses the blackboard guard in
 *       {@code WorkItemLifecycleAdapter}.
 * </ul>
 *
