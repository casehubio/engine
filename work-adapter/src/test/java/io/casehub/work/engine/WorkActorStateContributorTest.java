...
class WorkActorStateContributorTest {
  ...
  void contribute_activeItems_callsAccumulatorForEach() {
    ...
    var item1 =
        workItem(id1, "Review SAR", WorkItemStatus.ASSIGNED, "case:" + caseId + "/pi:step-1");
    var item2 =
        workItem(
            id2, "Approve transfer", WorkItemStatus.IN_PROGRESS, "case:" + caseId + "/gate:42");
    ...
    verify(accumulator, org.mockito.Mockito.times(2))
        .workItem(
            idCaptor.capture(),
            titleCaptor.capture(),
  ...
  void contribute_planItemCallerRef_extractsCaseId() {
    ...
    var item = workItem(id, "Task", WorkItemStatus.ASSIGNED, "case:" + caseId + "/pi:plan-item-1");
  ...
  void contribute_gateCallerRef_extractsCaseId() {
    ...
    var item = workItem(id, "Gate", WorkItemStatus.IN_PROGRESS, "case:" + caseId + "/gate:99");
  ...
  void contribute_nonEngineCallerRef_caseIdIsNull() {
    var id = UUID.randomUUID();
    var item =
        workItem(id, "Qhorus task", WorkItemStatus.ASSIGNED, "qhorus:channel-1/msg-1/corr-1");
