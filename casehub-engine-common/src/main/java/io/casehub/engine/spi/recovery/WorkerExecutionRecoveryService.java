 ...
 */
package io.casehub.engine.spi.recovery;
...
/**
 * Service for recovering worker execution state after a restart.
 *
 * <p>This service is responsible for:
 *
 * <ul>
 *   <li>Loading case instances and restoring their state from the event log
 *   <li>Recovering pending scheduled workers that were not yet executed
 * </ul>
 *
 * <p>Uses the repository SPI to access persisted data.
 *
 * @see io.casehub.engine.spi.CaseInstanceRepository
 * @see io.casehub.engine.spi.EventLogRepository
 */
