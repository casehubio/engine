...
/**
 * Comprehensive test suite for JQEvaluator.
 * Tests cover various JQ expression patterns and edge cases.
 */
@QuarkusTest
...
class JQEvaluatorTest {
    ...
    class LogicalOperators {
        ...
        void testOr_FirstTrue() throws Exception {
            ...
            ValidationResult result = jqEvaluator.eval(
                    ".status == \"processing\" or .status == \"pending\"", input);
        ...
        void testAnd_BothTrue() throws Exception {
            ...
            ValidationResult result = jqEvaluator.eval(
                    ".status == \"processing\" and .priority == \"high\"", input);
    ...
    class NestedFieldAccess {
        ...
        void testDeeplyNestedField() throws Exception {
            ...
            ValidationResult result = jqEvaluator.eval(
                    ".data.document.metadata.status == \"processing\"", input);
    ...
    class ArrayOperations {
        ...
        void testArrayAny() throws Exception {
            ...
            ValidationResult result = jqEvaluator.eval(
                    "any(.documents[]; .status == \"processing\")", input);
        ...
        void testArrayAll_True() throws Exception {
            ...
            ValidationResult result = jqEvaluator.eval(
                    "all(.documents[]; .status == \"processing\")", input);
        ...
        void testArrayIteration() throws Exception {
            ...
            ValidationResult result = jqEvaluator.eval(
                    ".documents[] | .status == \"processing\"", input);
    ...
    class StringOperations {
        ...
        void testContains() throws Exception {
            ...
            ValidationResult result = jqEvaluator.eval(
                    ".message | contains(\"Processing\")", input);
        ...
        void testStartsWith() throws Exception {
            ...
            ValidationResult result = jqEvaluator.eval(
                    ".filename | startswith(\"document\")", input);
    ...
    class ComplexExpressions {
        ...
        void testComplexCondition() throws Exception {
            ...
            ValidationResult result = jqEvaluator.eval(
                    ...
                    ".document.metadata.urgent == true", input);
    ...
    class RealWorldScenarios {
        ...
        void testDocumentProcessingTrigger() throws Exception {
            ...
            ValidationResult result = jqEvaluator.eval(
                    ".status == \"processing\" and .assignedTo == null", input);
        ...
        void testAllDocumentsReady() throws Exception {
            ...
            ValidationResult result = jqEvaluator.eval(
                    "all(.documents[]; .status == \"ready\")", input);
        ...
        void testTimeThreshold() throws Exception {
            ...
            ValidationResult result = jqEvaluator.eval(
                    "(.updatedAt - .createdAt) > 500000", input);
