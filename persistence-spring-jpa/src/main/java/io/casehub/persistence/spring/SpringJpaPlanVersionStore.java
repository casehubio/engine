...
import io.casehub.persistence.jpa.PlanVersionEntity;
...
@Transactional
class SpringJpaPlanVersionStore implements PlanVersionStore {

  private final EntityManager em;
  private final TenantContextManager tcm;

  SpringJpaPlanVersionStore(EntityManager em, TenantContextManager tcm) {
    this.em = em;
    this.tcm = tcm;
  }
