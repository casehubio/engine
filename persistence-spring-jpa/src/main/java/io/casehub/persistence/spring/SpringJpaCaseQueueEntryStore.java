...
import io.casehub.persistence.jpa.CaseQueueEntryEntity;
...
@Transactional
class SpringJpaCaseQueueEntryStore implements CaseQueueEntryStore {

  private final EntityManager em;
  private final TenantContextManager tcm;

  SpringJpaCaseQueueEntryStore(EntityManager em, TenantContextManager tcm) {
    this.em = em;
    this.tcm = tcm;
  }
