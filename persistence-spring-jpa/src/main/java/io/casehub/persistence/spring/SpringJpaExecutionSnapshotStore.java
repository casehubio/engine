...
import io.casehub.persistence.jpa.ExecutionSnapshotEntity;
...
@Transactional
class SpringJpaExecutionSnapshotStore implements ExecutionSnapshotStore {

  private final EntityManager em;
  private final TenantContextManager tcm;

  SpringJpaExecutionSnapshotStore(EntityManager em, TenantContextManager tcm) {
    this.em = em;
    this.tcm = tcm;
  }
