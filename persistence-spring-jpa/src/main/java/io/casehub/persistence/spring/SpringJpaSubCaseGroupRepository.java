...
import io.casehub.persistence.jpa.SubCaseGroupEntity;
...
@Transactional
class SpringJpaSubCaseGroupRepository implements SubCaseGroupRepository {

  private final EntityManager em;
  private final TenantContextManager tcm;

  SpringJpaSubCaseGroupRepository(EntityManager em, TenantContextManager tcm) {
    this.em = em;
    this.tcm = tcm;
  }
